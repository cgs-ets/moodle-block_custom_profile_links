 ...
 */
function block_custom_profile_links_pluginfile($course, $birecordorcm, $context, $filearea, $args,
    ...
    if (!$file = $fs->get_file($context->id, 'block_custom_profile_links', 'icons', $itemid, $filepath, $filename)
